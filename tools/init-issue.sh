...
#
# issueDir  — folder name under issues/ (e.g. issue-001)
...
# dialogue.txt template
cat > "${PUBLISHED_DIR}/dialogue.txt" << 'EOF'
...
# Initial manifest.json — will be regenerated by gen-manifest.mjs with real pages
cat > "${PUBLISHED_DIR}/manifest.json" << EOF
{
  "schemaVersion": 1,
